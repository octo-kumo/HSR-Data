...
LIGHT_CONES = STAR_RAIL_RES_PATH + "/index_new/cn/light_cones.json"
LIGHT_CONE_RANKS = STAR_RAIL_RES_PATH + "/index_new/cn/light_cone_ranks.json"
LIGHT_CONE_PROMOTIONS = STAR_RAIL_RES_PATH + "/index_new/cn/light_cone_promotions.json"
RELICS = STAR_RAIL_RES_PATH + "/index_new/cn/relics.json"
RELIC_SETS = STAR_RAIL_RES_PATH + "/index_new/cn/relic_sets.json"
CHARACTERS = STAR_RAIL_RES_PATH + "/index_new/cn/characters.json"
CHARACTER_SKILLS = STAR_RAIL_RES_PATH + "/index_new/cn/character_skills.json"
CHARACTER_SKILL_TREES = STAR_RAIL_RES_PATH + "/index_new/cn/character_skill_trees.json"
CHARACTER_RANKS = STAR_RAIL_RES_PATH + "/index_new/cn/character_ranks.json"
CHARACTER_PROMOTIONS = STAR_RAIL_RES_PATH + "/index_new/cn/character_promotions.json"
